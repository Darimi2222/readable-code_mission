...
public class ConsoleOutputHandler implements OutputHandler {
    ...
    public void showPassOrderSummary(Order order) {
        ...
        StudyCafeLockerTicket selectedLockerTicket = order.getStudyCafeLockerTicket();

        System.out.println();
        System.out.println("이용 내역");
        System.out.println("이용권: " + selectedPass.display());
        if (selectedLockerTicket != null) {
            System.out.println("사물함: " + selectedLockerTicket.display());
        }
